...
// browse is a simple command-line tool to browse the address space of an OPC UA server.
...
func main() {
	endpoint := flag.String("endpoint", "opc.tcp://0.0.0.0:4840/freeopcua/server/", "OPC UA Endpoint URL")
	nodeID := flag.String("node", "ns=2;i=1", "node id for the root node")
